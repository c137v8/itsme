...
function Navbar() {
  ...
  return (
    <nav className="fixed top-0 left-0 w-full bg-/80 backdrop-blur z-50 flex justify-center gap-8 py-4 text-lg">
      {links.map((link) => (
        <a
          key={link}
...
function About() {
  return (
    ...
    >
      <RevealOnScroll>
        <div className="flex flex-col items-center text-center bg-black/50 backdrop-blur-md p-8 rounded-xl">
...
function Projects({ repos, loading, error }) {
  return (
    ...
    >
      <RevealOnScroll>
        <div className="bg-black/50 backdrop-blur-md p-8 rounded-xl">
